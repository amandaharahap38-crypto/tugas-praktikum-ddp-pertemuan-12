...
if menu == "Luas Persegi":
    ...
    # Image
    st.image("https://www.doyanblog.com/wp-content/uploads/2021/12/rumus-persegi.jpg.webp", caption="Rumus Luas Persegi", width=300)
    ...
    # Image
    st.image("https://asset.tribunnews.com/Ot2mFn32Yz1mPgWHSkoinNy0jmE=/1200x675/filters:upscale():quality(30):format(webp):focal(0.5x0.5:0.5x0.5)/tribunnews/foto/bank/originals/rumus-luas-segitigaa.jpg", caption="Rumus Luas Segitiga", width=300)
